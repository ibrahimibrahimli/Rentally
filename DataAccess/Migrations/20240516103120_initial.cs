        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamBoards_Positions_PositionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickUpLocation = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    DropOffLocation = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PickUpDateTime = table.Column<DateTime>(type: "datetime2", maxLength: 50, nullable: false),
                    DropOffDateTime = table.Column<DateTime>(type: "datetime2", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favourites_Cars", x => new { x.CarsId, x.FavouritesId });
                    table.ForeignKey(
                        name: "FK_Favourites_Cars_Cars_CarsId",
                        column: x => x.CarsId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favourites_Cars_Favourites_FavouritesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favourites_Cars_FavouritesId",
                table: "Favourites_Cars",
                column: "FavouritesId");
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Testimonials",
                columns: new[] { "CustomerName", "Deleted" },
                unique: true);
